...
store.defineType('footballmatch', {
   matchevents: {link: 'matchevent', isArray: true,  inverse: 'footballmatch'} ,
   home: {type: String},
   away: {type: String},
   result: {type: String}
});

store.defineType('matchevent', {
    playername: {type: String},
    eventtype: {type: String},
    time: {type: String},
    footballmatch: {link: 'footballmatch',  inverse: 'matchevents'}
